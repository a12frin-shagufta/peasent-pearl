...
const bannerText = maxPercent > 0
  ...
  {bannerText ? (
    <div className="flex items-center justify-center w-full">
      ...
      <div className="hidden md:flex items-center ml-4 pl-4 border-l border-amber-200">
        <span className="text-xs text-amber-700 font-bold uppercase">
          ...
          Delivery time is 12-15 working days
        </span>
      </div>
    </div>
  ) : (
    <div className="text-sm text-amber-800 font-medium flex items-center">
      ...
      <span className="hidden sm:inline font-bold uppercase">Delivery time is 12-15 working days </span>
      <span className="sm:hidden font-bold uppercase">Delivery time is 12-15 working days </span>
